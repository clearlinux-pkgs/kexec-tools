...
Version  : 2.0.27
Release  : 23
URL      : https://www.kernel.org/pub/linux/utils/kernel/kexec/kexec-tools-2.0.27.tar.xz
Source0  : https://www.kernel.org/pub/linux/utils/kernel/kexec/kexec-tools-2.0.27.tar.xz
...
%prep
%setup -q -n kexec-tools-2.0.27
cd %{_builddir}/kexec-tools-2.0.27
pushd ..
cp -a kexec-tools-2.0.27 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701987392
