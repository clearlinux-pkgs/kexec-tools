...
Source0  : https://www.kernel.org/pub/linux/utils/kernel/kexec/kexec-tools-2.0.29.tar.gz
...
%prep
%setup -q -n kexec-tools-2.0.29
cd %{_builddir}/kexec-tools-2.0.29
pushd ..
cp -a kexec-tools-2.0.29 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721313956
