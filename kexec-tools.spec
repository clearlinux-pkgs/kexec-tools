...
Source0  : https://www.kernel.org/pub/linux/utils/kernel/kexec/kexec-tools-2.0.24.tar.xz
...
%prep
%setup -q -n kexec-tools-2.0.24
cd %{_builddir}/kexec-tools-2.0.24
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649521014
...
cp %{_builddir}/kexec-tools-2.0.24/COPYING %{buildroot}/usr/share/package-licenses/kexec-tools/c1f673dec6037696f751588854283118d7c38db3
%make_install
