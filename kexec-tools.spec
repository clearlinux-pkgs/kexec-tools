...
Version  : 2.0.30
Release  : 26
URL      : https://www.kernel.org/pub/linux/utils/kernel/kexec/kexec-tools-2.0.30.tar.gz
Source0  : https://www.kernel.org/pub/linux/utils/kernel/kexec/kexec-tools-2.0.30.tar.gz
...
%prep
%setup -q -n kexec-tools-2.0.30
cd %{_builddir}/kexec-tools-2.0.30
pushd ..
cp -a kexec-tools-2.0.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733162329
